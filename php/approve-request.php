...
try {
    ...
    $mail->isHTML(true);
    $mail->Subject = 'Yêu cầu trợ cấp của bạn đã được duyệt';
    $mail->Body = "
        <p>Yêu cầu trợ cấp của bạn đã được duyệt. Dưới đây là thông tin chi tiết:</p>
        <ul>
    ...
    $mail->send();
    echo json_encode(['success' => true, 'message' => 'Yêu cầu đã được duyệt và email thông báo đã được gửi.']);
} catch (Exception $e) {
